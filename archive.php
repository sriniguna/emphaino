					...
					<h1 class="page-title">
						<?php
							if ( is_category() ) {
								...
								*/
								the_post();
								printf( __( 'Author Archives: %s', 'emphaino' ), '<span class="vcard"><a class="url fn n" href="' . get_author_posts_url( get_the_author_meta( "ID" ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
